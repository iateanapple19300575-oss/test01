...
Public Class WorkMergeService2
...
"
    ...
    End Sub
    Public Sub BulkInsertActualTemp2(dt As DataTable, cn As SqlConnection, tr As SqlTransaction)

        Using bulk As New SqlBulkCopy(cn, SqlBulkCopyOptions.Default, tr)
            bulk.DestinationTableName = "#ActualTemp"

            bulk.ColumnMappings.Add("WorkDate", "WorkDate")
            bulk.ColumnMappings.Add("WorkNo", "WorkNo")
            bulk.ColumnMappings.Add("ActualStaffId", "ActualStaffId")
            bulk.ColumnMappings.Add("StartTime", "StartTime")
            bulk.ColumnMappings.Add("EndTime", "EndTime")
